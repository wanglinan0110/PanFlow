...
```bash
python3 run_panflow.py examples/design_doc.md
```

指定输出路径：

```bash
python3 run_panflow.py examples/design_doc.md -o build/design_doc.docx
```

只生成中间 HTML：

```bash
python3 run_panflow.py render examples/design_doc.md
```
...
mdToWord examples/design_doc.md
```
...
- `examples/design_doc.md`
- `examples/design_doc.py`
- `examples/design_doc_normal_type.py`
- `examples/design_doc_static_analysis.py`
- `examples/design_doc_test_case.py`
- `examples/design_doc_traceability_matrix.py`
